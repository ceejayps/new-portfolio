...
<div className="bg-white py-6 sm:py-8 lg:py-12">
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="grid gap-4 sm:grid-cols-2 md:gap-4 max-w-3xl mx-auto text-left xl:grid-cols-2 xl:gap-4">
      ...
      <div className="flex gap-4 md:gap-6">
        <div className="flex h-12 w-12  hover:h-16  hover:w-16 transition-all duration-500 cursor-pointer shrink-0 items-center justify-center rounded-lg bg-indigo-500 text-white shadow-lg md:h-14 md:w-14 md:rounded-xl">
